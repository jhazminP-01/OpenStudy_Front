...
const ReportUserModal = ({ visible, onClose, reportedUser, salaId }) => {
  const { user } = useAuth();
        ...
        <View style={styles.container}>
          ...
          {success ? (
            <View style={styles.successContainer}>
              ...
              <Text style={styles.successSub}>Gracias por ayudar a mantener un entorno seguro.</Text>
            </View>
          ) : (
            <ScrollView style={styles.body} showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.userInfo}>
                ...
                <Text style={styles.userName}>{reportedUser?.nombre_completo || 'Usuario'}</Text>
              </View>
